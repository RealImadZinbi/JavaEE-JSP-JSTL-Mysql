...
<html>
 ...
 <body>
    ...
    ArrayList <Commande> list = new ArrayList <Commande> ();
     list =(ArrayList <Commande>)request.getAttribute("decription");
            ...
            <div class="row">
               <div class="col-sm-6">
                    ...
                    <div class="form-actions">
                      <a class="btn btn-primary" href="<%= request.getContextPath()%>//MesCommandeFournisseurs"><span class="glyphicon glyphicon-arrow-left"></span> Retour</a>  
                    
                </div> 
              
                      </div>
                </div>
                  <center>  <button type="button" class="btn btn-primary"  data-toggle="modal" data-target="#Modals" ><span class="glyphicon glyphicon-pencil	
              "></span>Prendre une décision</button> </li></center>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
				...
				<td><button type="button" class="btn btn-danger">Rejeter</button>	             
    </body>
</html>
