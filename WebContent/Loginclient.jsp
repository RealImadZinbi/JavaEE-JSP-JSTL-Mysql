...
<body>
	...
	<form method ="post" action="<%= request.getContextPath() %>/login"/login>
                           ...
                           <div class="form-group">
                              <p class="text-center"><h2>By signing up you accept our</h2> <a href="#"><h2>Terms Of Use</h2></a></p>
                           </div>
                           <div class="col-md-12 text-center ">
                           ...
                           <div class="form-group">
                              <p class="text-center">Don't have account? <a href="<%= request.getContextPath() %>/Registrationclient.jsp" id="signup">Sign up here</a></p>
                           </div>
                        </form>
